...
public extension QLView {
    ...
    func forceContentWrap(_ axes: QLAxis...) {
        if axes.contains(.vertically) {
            verticalHuggingPriority = UILayoutPriority.required
            verticalCompressionResistancePriority = UILayoutPriority.required
        }
        if axes.contains(.horizontally) {
            horizontalHuggingPriority = UILayoutPriority.required
            horizontalCompressionResistancePriority = UILayoutPriority.required
        }
    }
