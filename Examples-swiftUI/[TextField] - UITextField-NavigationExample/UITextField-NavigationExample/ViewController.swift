...
//  UITextField-NavigationExample
//
//  Created by huy on 2026/02/19.
//
...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var tfield1: UITextField!
    @IBOutlet weak var tfield2: UITextField!
    ...
    func setupTextFieldCode() {
        textFieldCode1 = createRightTextField("UITextField Code 1", leftField: tfield1)
        textFieldCode2 = createRightTextField("UITextField Code 2", leftField: tview)
        textFieldCode3 = createRightTextField("UITextField Code 3", leftField: tfield2)
        
        tfield1.nextNavigationField = textFieldCode1
        textFieldCode1.nextNavigationField = tfield2
        textFieldCode2.nextNavigationField = tview
