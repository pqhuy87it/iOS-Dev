//
//  animation_basic_animations.swift
//  Thực hành 3 animation cơ bản: Microphone Pulse, Heart Reaction, Sparkle Glow
//
//  Cách dùng: mở app -> chọn "Basic Animations" ở menu.
//
